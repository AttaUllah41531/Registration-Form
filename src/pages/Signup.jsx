...
const EyeOffIcon = (
  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2"
    viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round"
      d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.965 9.965 0 012.073-3.275M6.12 6.12l11.76 11.76M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
)
...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-100 to-indigo-100 px-4">
      <div className="w-full max-w-md bg-purple-700/90 rounded-2xl shadow-xl p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Input
            ...
            placeholder="Email"
            value={email}
            onChange={e => setEmail(e.target.value)} icon={EmailIcon}
          />
        ...
        <div className="mt-6 space-y-3">
          ...
          <SocialButton icon={GitHubIcon} text="Sign up with GitHub" />
        </div>
